...
//  tree_u238->Draw("sqrt(edepX^2+edepY^2+edepZ^2)>>h_pos_u238(1000,0,18000)","Qedep>0.7","");
  tree_u238->Draw("sqrt(edepX^2+edepY^2+edepZ^2)>>h_pos_u238(1000,0,18000)","Qedep>0.7","");
  ...
  tree_u234->Draw("sqrt(edepX^2+edepY^2+edepZ^2)>>h_pos_u234(1000,0,18000)","Qedep>0.7","");
  ...
  tree_bi214->Draw("sqrt(edepX^2+edepY^2+edepZ^2)>>h_pos_bi214(1000,0,18000)","Qedep>0.7","");
  ...
  // bi210
    ...
    tree_bi210->Draw("sqrt(edepX^2+edepY^2+edepZ^2)>>h_pos_bi210(1000,0,18000)","Qedep>0.7","");
  ...
  // pa234
    ...
    tree_pa234->Draw("sqrt(edepX^2+edepY^2+edepZ^2)>>h_pos_pa234(1000,0,18000)","Qedep>0.7","");
    ...
    tree_pb210->Draw("sqrt(edepX^2+edepY^2+edepZ^2)>>h_pos_pb210(1000,0,18000)","Qedep>0.7","");
    ...
    tree_pb214->Draw("sqrt(edepX^2+edepY^2+edepZ^2)>>h_pos_pb214(1000,0,18000)","Qedep>0.7","");
    ...
    tree_po210->Draw("sqrt(edepX^2+edepY^2+edepZ^2)>>h_pos_po210(1000,0,18000)","Qedep>0.7","");
    ...
    tree_po214->Draw("sqrt(edepX^2+edepY^2+edepZ^2)>>h_pos_po214(1000,0,18000)","Qedep>0.7","");
    ...
    tree_po218->Draw("sqrt(edepX^2+edepY^2+edepZ^2)>>h_pos_po218(1000,0,18000)","Qedep>0.7","");
    ...
    tree_ra226->Draw("sqrt(edepX^2+edepY^2+edepZ^2)>>h_pos_ra226(1000,0,18000)","Qedep>0.7","");
    ...
    tree_rn222->Draw("sqrt(edepX^2+edepY^2+edepZ^2)>>h_pos_rn222(1000,0,18000)","Qedep>0.7","");
    ...
    tree_th230->Draw("sqrt(edepX^2+edepY^2+edepZ^2)>>h_pos_th230(1000,0,18000)","Qedep>0.7","");
    ...
    tree_th234->Draw("sqrt(edepX^2+edepY^2+edepZ^2)>>h_pos_th234(1000,0,18000)","Qedep>0.7","");
...
TH1F *h_pos_sum = (TH1F*)h_pos_pb210->Clone("h_pos_sum");
  h_pos_sum->Add(h_pos_bi210);
  h_pos_sum->Add(h_pos_po210);
