...
void readtree(){
  ...
  tree_k40->Draw("Qedep>>h_qedep_k40(1200,0,12)","sqrt(InitX*InitX + InitY*InitY + InitZ*InitZ)<18000 && sqrt(edepX*edepX + edepY*edepY + edepZ*edepZ)<18000","");
// tree_k40->Draw("Qedep>>h_qedep_k40(1200,0,12)","edep>0","");
  ...
  TH2F *h_guide = new TH2F("h_guide","",1,0,2,1,0.5,1000000);
...
//  gStyle->SetOptStat(0);
  ...
  double a = h_qedep_k40->Integral(h_qedep_k40->FindFixBin(0.7), h_qedep_k40->FindFixBin(8));
   ...
   double b = h_qedep_k40->Integral(h_qedep_k40->FindFixBin(0), h_qedep_k40->FindFixBin(8));
    printf("number of events over 0 MeV =  %f \n", b );
