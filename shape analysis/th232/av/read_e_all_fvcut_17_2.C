...
void readtree(){
  ...
  tree_th232->Draw("Qedep>>h_qedep_th232(4000,0,8)","sqrt(InitX*InitX + InitY*InitY + InitZ*InitZ)  <18000 && sqrt(edepX*edepX + edepY*edepY + edepZ*edepZ)<18000","");
  ...
  tree_ra228->Draw("Qedep>>h_qedep_ra228(4000,0,8)","sqrt(InitX*InitX + InitY*InitY + InitZ*InitZ)  <18000 && sqrt(edepX*edepX + edepY*edepY + edepZ*edepZ)<18000","");
  ...
  tree_ac228->Draw("Qedep>>h_qedep_ac228(4000,0,8)","sqrt(InitX*InitX + InitY*InitY + InitZ*InitZ)  <18000 && sqrt(edepX*edepX + edepY*edepY + edepZ*edepZ)<18000","");
  ...
  // th228
    ...
    tree_th228->Draw("Qedep>>h_qedep_th228(4000,0,8)","sqrt(InitX*InitX + InitY*InitY + InitZ*InitZ)  <18000 && sqrt(edepX*edepX + edepY*edepY + edepZ*edepZ)<18000","");
  ...
  // ra224
    ...
    tree_ra224->Draw("Qedep>>h_qedep_ra224(4000,0,8)","sqrt(InitX*InitX + InitY*InitY + InitZ*InitZ)  <18000 && sqrt(edepX*edepX + edepY*edepY + edepZ*edepZ)<18000","");
    ...
    tree_rn220->Draw("Qedep>>h_qedep_rn220(4000,0,8)","sqrt(InitX*InitX + InitY*InitY + InitZ*InitZ)  <18000 && sqrt(edepX*edepX + edepY*edepY + edepZ*edepZ)<18000","");
    ...
    tree_po216->Draw("Qedep>>h_qedep_po216(4000,0,8)","sqrt(InitX*InitX + InitY*InitY + InitZ*InitZ)  <18000 && sqrt(edepX*edepX + edepY*edepY + edepZ*edepZ)<18000","");
    ...
    tree_pb212->Draw("Qedep>>h_qedep_pb212(4000,0,8)","sqrt(InitX*InitX + InitY*InitY + InitZ*InitZ)  <18000 && sqrt(edepX*edepX + edepY*edepY + edepZ*edepZ)<18000","");
    ...
    tree_bi212->Draw("Qedep>>h_qedep_bi212(4000,0,8)","sqrt(InitX*InitX + InitY*InitY + InitZ*InitZ)  <18000 && sqrt(edepX*edepX + edepY*edepY + edepZ*edepZ)<18000","");
    ...
    tree_tl208->Draw("Qedep>>h_qedep_tl208(4000,0,8)","sqrt(InitX*InitX + InitY*InitY + InitZ*InitZ)  <18000 && sqrt(edepX*edepX + edepY*edepY + edepZ*edepZ)<18000","");
    ...
    tree_po212->Draw("Qedep>>h_qedep_po212(4000,0,8)","sqrt(InitX*InitX + InitY*InitY + InitZ*InitZ)  <18000 && sqrt(edepX*edepX + edepY*edepY + edepZ*edepZ)<18000","");
  ...
  h_qedep_tl208->Draw("SAME");
  h_qedep_po212->Draw("SAME");
  ...
  double a19 = h_qedep_sum->Integral(h_qedep_sum->FindFixBin(0.1), h_qedep_sum->FindFixBin(8));
  printf("number of events over 0.1 MeV =  %f \n", a19 );

  double a18 = h_qedep_sum->Integral(h_qedep_sum->FindFixBin(0.2), h_qedep_sum->FindFixBin(8));
  printf("number of events over 0.2 MeV =  %f \n", a18 );


  double a17 = h_qedep_sum->Integral(h_qedep_sum->FindFixBin(0.3), h_qedep_sum->FindFixBin(8));
  printf("number of events over 0.3 MeV =  %f \n", a17 );

  double a16 = h_qedep_sum->Integral(h_qedep_sum->FindFixBin(0.4), h_qedep_sum->FindFixBin(8));
  printf("number of events over 0.4 MeV =  %f \n", a16 );



  double a0 = h_qedep_sum->Integral(h_qedep_sum->FindFixBin(0.5), h_qedep_sum->FindFixBin(8));
   printf("number of events over 0.5 MeV =  %f \n", a0 );

  double a1 = h_qedep_sum->Integral(h_qedep_sum->FindFixBin(0.6), h_qedep_sum->FindFixBin(8));
   printf("number of events over 0.6 MeV =  %f \n", a1 );

   double a2 = h_qedep_sum->Integral(h_qedep_sum->FindFixBin(0.7), h_qedep_sum->FindFixBin(8));
    printf("number of events over 0.7 MeV =  %f \n", a2 );

    double a3 = h_qedep_sum->Integral(h_qedep_sum->FindFixBin(0.8), h_qedep_sum->FindFixBin(8));
    printf("number of events over 0.8 MeV =  %f \n", a3 );

    double a4 = h_qedep_sum->Integral(h_qedep_sum->FindFixBin(0.9), h_qedep_sum->FindFixBin(8));
    printf("number of events over 0.9 MeV =  %f \n", a4 );

    double a5 = h_qedep_sum->Integral(h_qedep_sum->FindFixBin(1), h_qedep_sum->FindFixBin(8));
    printf("number of events over 1 MeV =  %f \n", a5 );

    double a6 = h_qedep_sum->Integral(h_qedep_sum->FindFixBin(1.1), h_qedep_sum->FindFixBin(8));
    printf("number of events over 1.1 MeV =  %f \n", a6 );

    double a7 = h_qedep_sum->Integral(h_qedep_sum->FindFixBin(1.2), h_qedep_sum->FindFixBin(8));
    printf("number of events over 1.2 MeV =  %f \n", a7 );

    double a8 = h_qedep_sum->Integral(h_qedep_sum->FindFixBin(1.3), h_qedep_sum->FindFixBin(8));
    printf("number of events over 1.3 MeV =  %f \n", a8 );

    double a9 = h_qedep_sum->Integral(h_qedep_sum->FindFixBin(1.4), h_qedep_sum->FindFixBin(8));
    printf("number of events over 1.4 MeV =  %f \n", a9 );

    double a10 = h_qedep_sum->Integral(h_qedep_sum->FindFixBin(1.5), h_qedep_sum->FindFixBin(8));
    printf("number of events over 1.5 MeV =  %f \n", a10 );

    double a11 = h_qedep_sum->Integral(h_qedep_sum->FindFixBin(1.6), h_qedep_sum->FindFixBin(8));
    printf("number of events over 1.6 MeV =  %f \n", a11 );

    double a12 = h_qedep_sum->Integral(h_qedep_sum->FindFixBin(1.7), h_qedep_sum->FindFixBin(8));
    printf("number of events over 1.7 MeV =  %f \n", a12 );

    double a13 = h_qedep_sum->Integral(h_qedep_sum->FindFixBin(1.8), h_qedep_sum->FindFixBin(8));
    printf("number of events over 1.8 MeV =  %f \n", a13 );

    double a14 = h_qedep_sum->Integral(h_qedep_sum->FindFixBin(1.9), h_qedep_sum->FindFixBin(8));
    printf("number of events over 1.9 MeV =  %f \n", a14 );

    double a15 = h_qedep_sum->Integral(h_qedep_sum->FindFixBin(2), h_qedep_sum->FindFixBin(8));
    printf("number of events over 2 MeV =  %f \n", a15 );


   double c = h_qedep_sum->Integral(h_qedep_sum->FindFixBin(0), h_qedep_sum->FindFixBin(8));
    printf("Total number of event with BR applied =  %f \n", c );
