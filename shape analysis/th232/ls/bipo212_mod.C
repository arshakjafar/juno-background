...
float qedep_bi212, qedep_po212 , edep_bi212;
...
tree_bi212->SetBranchAddress("Qedep",&qedep_bi212);
tree_po212->SetBranchAddress("Qedep",&qedep_po212);
tree_bi212->SetBranchAddress("edep",&edep_bi212);

TH1D *h_qedep_bi212 = new TH1D("h_qedep_bi212","",4000,0,8);
TH1D *h_qedep_po212 = new TH1D("h_qedep_po212","",4000,0,8);
TH1D *h_qedep_bipo212 = new TH1D("h_qedep_bipo212","",4000,0,8);

int j=0;

for(Int_t i=0;i<tree_bi212->GetEntries();i++){
  tree_bi212->GetEntry(i);

  if (edep_bi212 > 2.5) {
    h_qedep_bi212->Fill(qedep_bi212);
  }
  if (edep_bi212 < 2.5) {
    tree_po212->GetEntry(j);
    if (exitt_po212 <= 300) {
       float qedep_bipo212 = qedep_po212 + qedep_bi212 ;
       h_qedep_bipo212->Fill(qedep_bipo212);
    }
    if (exitt_po212 >300) {
       h_qedep_po212->Fill(qedep_po212);
       h_qedep_bi212->Fill(qedep_bi212);
    }
    j++;
  }
  ...
  h_qedep_sum->Add(h_qedep_bipo212);
  ...
  h_qedep_bipo212->SetLineColor(12);
  h_qedep_sum->SetLineColor(1);

  h_qedep_sum->SetLineWidth(2);
  h_qedep_bipo212->SetLineWidth(2);
  h_qedep_bi212->SetLineWidth(2);
  h_qedep_po212->SetLineWidth(2);
  ...
  legend->AddEntry(h_qedep_bipo212, "Bi212 + Po212", "l");
  legend->AddEntry(h_qedep_sum, "Total Spectrum", "l");



  TH2F *h_guide = new TH2F("h_guide","",1,0,4,1,0.5,1000000);

  h_guide->GetXaxis()->SetTitle("Quenched energy [MeV]");
  h_guide->GetYaxis()->SetTitle("Counts / 2 keV");
  h_guide->SetTitle("Quenched Energy  - th232 Chain in LS - Bi212 + Po212  300 ns ");
  ...
  printf("Number of entries in h_qedep_bipo212 %f \n", h_qedep_bipo212->GetEntries());
...
//  c1->Print("th232bipo_300ns_04_v2.pdf");
}
