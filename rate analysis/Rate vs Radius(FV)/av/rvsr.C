...
void rvsr(){
  ...
  fstream file_u238, file_th232, file_k40;
  ...
  while (1) {
    float e_u238, e_th232, e_k40, r_u238, r_th232, r_k40;
...
//    cout << "K40 " << counter << ": " << e_k40 << " " << r_k40 << endl;
  ...
  mg->GetHistogram()->SetTitle("Rate vs Radius in Acrylic Vessel With E_{th} 0.7 MeV");

  c1->Print("R_vs_R_AV_v3.pdf");
}
